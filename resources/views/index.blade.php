...
<body>
    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li><a class="btn btn-primary text-light" href="{{ route('signup') }}">Créer un compte</a></li>
        </ul>
      </nav><!-- .main-nav -->
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>Nous avons une <br><span>solution</span> idéale<br>pour votre agence!</h2>
        <div>
          <a href="{{ route('login') }}" class="btn-get-started scrollto">Se connecter</a>
          <a href="{{ route('signup') }}" class="btn-services scrollto">S'inscrire</a>
        </div>
      </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-md-6 info">
                ...
                <p>Treichville, Avenue 16 Rue 42</p>
              </div>
              <div class="col-md-6 info">
                <i class="ion-ios-email-outline"></i>
                <p>contact-ci@ap2stechnologies.com</p>
              </div>
              <div class="col-md-6 info">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>MobileApp'Web</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
